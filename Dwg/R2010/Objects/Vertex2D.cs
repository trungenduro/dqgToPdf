...
// Type: dqgToPdf.Dwg.R2010.Objects.Vertex2D
...
{
  public class Vertex2D : CommonEntityData2010
  {
    ...
    private void LoadVertex2D(DwgBitArray ba)
    {
      ...
      this.VertexId = ba.ReadBL();
      Console.WriteLine(string.Format("VertexId: {0}", (object) this.VertexId));
