...
// Type: dqgToPdf.Dwg.R2010.Objects.Hatch
...
{
  public class Hatch : CommonEntityData2010
  {
            ...
            switch (pathTypeStatus)
            {
              ...
              case Hatch.PathType.SPLINE:
                ...
                for (int index3 = 0; index3 < pathSeg.NumKnots; ++index3)
                {
                  ...
                  Console.WriteLine(string.Format("ps.Knot: {0}", (object) num));
                }
                Console.WriteLine(string.Format("ps.NumControlPoints: {0}", (object) pathSeg.NumControlPoints));
                ...
                pathSeg.NumFitPoints = ba.ReadBL();
                Console.WriteLine(string.Format("ps.NumFitPoints: {0}", (object) pathSeg.NumFitPoints));
                for (int index3 = 0; index3 < pathSeg.NumFitPoints; ++index3)
                {
                  Point2D point2D = ba.Read2RD();
                  pathSeg.FitPoints.Add(point2D);
                  Console.WriteLine(string.Format("fitpoint: {0}", (object) point2D));
                }
                break;
              default:
                throw new NotImplementedException();
