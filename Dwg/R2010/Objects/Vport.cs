...
// Type: dqgToPdf.Dwg.R2010.Objects.Vport
...
{
  public class Vport : CommonNonEntityData
  {
    ...
    private void LoadVportData(DwgBitArray ba)
    {
      ...
      this.UseDefaultLights = ba.ReadB();
      Console.WriteLine(string.Format("UseDefaultLights: {0}", (object) this.UseDefaultLights));
      this.DefaultLighitingType = (int) ba.ReadByte();
      Console.WriteLine(string.Format("DefaultLighitingType: {0}", (object) this.DefaultLighitingType));
      this.Brightness = ba.ReadBD();
      Console.WriteLine(string.Format("Brightness: {0}", (object) this.Brightness));
      this.Constrast = ba.ReadBD();
      Console.WriteLine(string.Format("Constrast: {0}", (object) this.Constrast));
      this.AmbientColorIndex = (int) ba.ReadBS();
      Console.WriteLine(string.Format("AmbientColorIndex: {0}", (object) this.AmbientColorIndex));
      Console.WriteLine(string.Format("bl: {0}", (object) ba.ReadBL()));
      Console.WriteLine(string.Format("rc: {0}", (object) ba.ReadByte()));
      ...
      this.GridFlags = (int) ba.ReadBS();
      Console.WriteLine(string.Format("GridFlags: {0}", (object) this.GridFlags));
      this.GridMajor = (int) ba.ReadBS();
      Console.WriteLine(string.Format("GridMajor: {0}", (object) this.GridMajor));
      ...
      this.BackgroundHandle = ba.ReadH();
      Console.WriteLine(string.Format("BackgroundHandle: {0}", (object) this.BackgroundHandle));
      this.VisualStyleHandle = ba.ReadH();
      Console.WriteLine(string.Format("VisualStyleHandle: {0}", (object) this.VisualStyleHandle));
      this.SunHandle = ba.ReadH();
      Console.WriteLine(string.Format("SunHandle: {0}", (object) this.SunHandle));
