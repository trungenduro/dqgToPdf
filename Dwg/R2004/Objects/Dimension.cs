...
// Type: dqgToPdf.Dwg.R2004.Objects.Dimension
...
{
  public class Dimension : dqgToPdf.Dwg.R2004.CommonEntityData
  {
    ...
    {
      Reader.DrawBlockHeader((BlockHeader) objMap[this.AnonymousBlockHandle.getTargetHandle(this.ObjId)], po, objMap, new Point3D(), new Point3D()
      {
        x = this.InsXScale,
        y = this.InsYScale,
        z = this.InsZScale
