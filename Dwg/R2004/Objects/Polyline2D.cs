...
// Type: dqgToPdf.Dwg.R2004.Objects.Polyline2D
...
{
  public class Polyline2D : dqgToPdf.Dwg.R2004.CommonEntityData
  {
      ...
      : base(ba)
    {
      ...
      for (int index = 0; index < this.OwnedObjectCount; ++index)
      {
        ...
        Console.WriteLine(string.Format("VertexeHandle: {0}", (object) handleReference));
        this.VertexeHandles.Add(handleReference);
      }
