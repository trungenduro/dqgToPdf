...
// Type: dqgToPdf.Dwg.R2004.Reader
// Assembly: dqgToPdf, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// MVID: 62F9A02F-9825-49FD-9C39-99200611E8E8
// Assembly location: Z:\0_TRUNG\ToDHF20200809\PDFJump\PDFJump200808\dqgToPdf.dll

using dqgToPdf.Dwg.R2004.Objects;
using dqgToPdf.Dxf;
...
namespace dqgToPdf.Dwg.R2004
{
  public class Reader : IReader
  {
    ...
    private object ConverObject(short type, byte[] binaryData)
    {
      ...
      {
        case 1:
          return (object) new dqgToPdf.Dwg.R2004.Objects.Text(ba);
        case 4:
        ...
        case 42:
          return (object) new dqgToPdf.Dwg.R2004.Objects.Dictionary(ba);
        case 44:
      ...
      bool isInsert)
    {
      ...
      double num = Math.Abs(scale.x);
      po.SetLineWeight((double) ced.LineWeight / 100.0 / num);
    }
