...
// Type: dqgToPdf.Dwg.R2000.Objects.MLeaderAnnotContext
...
namespace dqgToPdf.Dwg.R2000.Objects
{
  public class MLeaderAnnotContext
  {
    ...
    private void loadMLeaderAnnotContextData(DwgBitArray ba)
    {
      ...
      {
        this.TextLabel = ba.ReadSJIS();
        Console.WriteLine("MLeaderAnnotContext.TextLabel: " + this.TextLabel);
        ...
        this.BackgroundFillColor = (int) ba.ReadBS();
