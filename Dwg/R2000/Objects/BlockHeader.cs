...
// Type: dqgToPdf.Dwg.R2000.Objects.BlockHeader
...
{
  public class BlockHeader : dqgToPdf.Dwg.R2000.CommonNonEntityData
  {
    ...
    public HandleReference FirstEntityHandle { get; set; }

    public HandleReference EndEntityHandle { get; set; }
    ...
    private void LoadBlockHeaderData(DwgBitArray ba)
    {
      ...
      if (!this.Blkisxref && !this.Xrefoverlaid)
      {
        this.FirstEntityHandle = ba.ReadH();
        Console.WriteLine(string.Format("FirstEntityHandle: {0}", (object) this.FirstEntityHandle));
        this.EndEntityHandle = ba.ReadH();
        Console.WriteLine(string.Format("EndEntityHandle: {0}", (object) this.EndEntityHandle));
      }
