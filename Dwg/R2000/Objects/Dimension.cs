...
// Type: dqgToPdf.Dwg.R2000.Objects.Dimension
...
{
  public class Dimension : dqgToPdf.Dwg.R2000.CommonEntityData
  {
    ...
    protected void DrawAnonymousBlock(
      PageObject po,
      Point3D basePt,
      double rotate,
      Dictionary<int, object> objMap)
    {
