...
// Type: dqgToPdf.Dwg.R2000.Objects.MText
...
{
  public class MText : dqgToPdf.Dwg.R2000.CommonEntityData
  {
    ...
    public override void WritePdf(PageObject po, Dictionary<int, object> objMap = null)
    {
      ...
      if (this.StyleHandle != null)
      {
        ...
        if (targetHandle != 0 && objMap.ContainsKey(targetHandle) && objMap[targetHandle] is ShapeFile shapeFile)
        {
