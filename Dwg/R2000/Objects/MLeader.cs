...
// Type: dqgToPdf.Dwg.R2000.Objects.MLeader
...
{
  public class MLeader : dqgToPdf.Dwg.R2000.CommonEntityData
  {
    ...
    public int LeaderColor { get; set; }
    ...
    private void loadMLeaderData(DwgBitArray ba)
    {
      ...
      this.LeaderColor = (int) ba.ReadBS();
      ...
      this.StyleTextColor = (int) ba.ReadBS();
      ...
      this.StyleBlockColor = (int) ba.ReadBS();
