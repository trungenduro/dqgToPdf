...
// Type: dqgToPdf.Dwg.R2000.Objects.MLineStyle
...
{
  public class MLineStyle : dqgToPdf.Dwg.R2000.CommonNonEntityData
  {
    ...
    private void LoadMLineStyle(DwgBitArray ba)
    {
      ...
      for (int index = 0; index < this.NumLinesInStyle; ++index)
      {
        ...
        lineInStyle.Color = (int) ba.ReadBS();
