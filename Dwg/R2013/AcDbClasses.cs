...
// Type: dqgToPdf.Dwg.R2013.AcDbClasses
...
namespace dqgToPdf.Dwg.R2013
{
  public class AcDbClasses
  {
    ...
    private void LoadAcdbClasses(DwgBitArray ba)
    {
      ...
      Console.WriteLine(string.Format("rl0: {0}", (object) ba.ReadRL()));
      this.SizeInBits = ba.ReadRL();
      Console.WriteLine(string.Format("SizeInBits: {0}", (object) this.SizeInBits));
    ...
    private void LoadClassData(DwgBitArray ba)
    {
      ...
      {
        Console.WriteLine(string.Format("cd.ClassNum: {0:x}", (object) classData.ClassNum));
        classData.AppName = ba.ReadTU();
        Console.WriteLine("cd.AppName: " + classData.AppName);
        classData.CppClassName = ba.ReadTU();
        Console.WriteLine("cd.CppClassName: " + classData.CppClassName);
        classData.ClassDxfName = ba.ReadTU();
