...
// Type: dqgToPdf.Dwg.R2013.Objects.DimstyleControl
...
{
  public class DimstyleControl : CommonNonEntityData
  {
    ...
    private void LoadDimStyleControl(DwgBitArray ba)
    {
      ...
      Console.WriteLine(string.Format("HasTextStream: {0}", (object) ba.ReadB()));
      this.Null = ba.ReadH();
