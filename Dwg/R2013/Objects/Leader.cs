...
// Type: dqgToPdf.Dwg.R2013.Objects.Leader
...
namespace dqgToPdf.Dwg.R2013.Objects
{
  public class Leader : CommonEntityData
  {
    ...
    private void LoadLeaderData(DwgBitArray ba)
    {
      ...
      this.Origin = ba.Read3BD();
      Console.WriteLine(string.Format("Origin: {0}", (object) this.Origin));
      ...
      Console.WriteLine(string.Format("UnknownDouble: {0}", (object) ba.ReadBD()));
