...
// Type: dqgToPdf.Dwg.R2013.Objects.BlockHeader
...
{
  public class BlockHeader : CommonNonEntityData
  {
    public string EntryName { get; set; }

    public bool Flag64bit { get; set; }
    ...
    public int InsertUnits { get; set; }

    public bool Explodable { get; set; }

    public int BlockScaling { get; set; }
    ...
    {
      this.Flag64bit = ba.ReadB();
      Console.WriteLine(string.Format("Flag64bit: {0}", (object) this.Flag64bit));
      ...
      this.InsertUnits = (int) ba.ReadBS();
      Console.WriteLine(string.Format("InsertUnits: {0}", (object) this.InsertUnits));
      this.Explodable = ba.ReadB();
      Console.WriteLine(string.Format("Explodable: {0}", (object) this.Explodable));
      this.BlockScaling = (int) ba.ReadByte();
      Console.WriteLine(string.Format("BlockScaling: {0}", (object) this.BlockScaling));
      Console.WriteLine("Remain Bits:" + ba.Residual.ToString());
      this.EntryName = ba.ReadTU();
      Console.WriteLine("EntryName: " + this.EntryName);
      this.XrefPname = ba.ReadTU();
