...
// Type: dqgToPdf.Dwg.R2013.Objects.Layer
...
namespace dqgToPdf.Dwg.R2013.Objects
{
  public class Layer : CommonNonEntityData
  {
    ...
    public HandleReference UnknownHandle { get; set; }
    ...
    private void LoadLayerData(DwgBitArray ba)
    {
      ...
      this.UnknownHandle = ba.ReadH();
      Console.WriteLine(string.Format("UnknownHandle: {0}", (object) this.UnknownHandle));
