...
// Type: dqgToPdf.Dwg.R2013.Reader
// Assembly: dqgToPdf, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// MVID: 62F9A02F-9825-49FD-9C39-99200611E8E8
// Assembly location: Z:\0_TRUNG\ToDHF20200809\PDFJump\PDFJump200808\dqgToPdf.dll

using dqgToPdf.Dwg.R2013.Objects;
using dqgToPdf.Dxf;
...
namespace dqgToPdf.Dwg.R2013
{
  ...
  {
    private static List<int> DrawedIds = new List<int>();
    ...
    private object ConverObject(short type, byte[] binaryData)
    {
      ...
      {
        case 1:
          return (object) new dqgToPdf.Dwg.R2013.Objects.Text(ba);
        case 2:
        ...
        case 42:
          return (object) new dqgToPdf.Dwg.R2013.Objects.Dictionary(ba);
        case 44:
          ...
          using (BinaryReader binaryReader = new BinaryReader((System.IO.Stream) new MemoryStream(DwgUtility.decompress(this.br.ReadBytes((int) num3), (int) num2))))
          {
            ...
            for (int index1 = 0; (long) index1 < (long) num6; ++index1)
            {
              ...
              for (int index2 = 0; (long) index2 < (long) num12; ++index2)
                dataSectionMap.SectionPageMapDatas.Add(new SectionPageMapData()
                {
                  PageNumber = num13 = binaryReader.ReadUInt32(),
                  DataSizeForThisPage = num13 = binaryReader.ReadUInt32(),
                  StartOffsetForThisPage = num11 = binaryReader.ReadUInt64()
                });
    ...
    public static void DrawBlockHeader(
      ...
      bool isInsert = false)
    {
      if (Reader.DrawedIds.Contains(blockHeader.ObjId))
        return;
